...
class AnalyticsUser(HttpUser):
    ...
    @task
    def spawning_greenlets(self):
        pool = Pool()
        pool.spawn(self.execute_job_explorer_options())
        pool.spawn(self.execute_job_explorer2())
        pool.spawn(self.execute_event_explorer7())
        pool.spawn(self.execute_job_event_explorer3())
        pool.spawn(self.execute_event_explorer2())
        pool.spawn(self.execute_adoption_rate4())
        pool.spawn(self.execute_job_explorer5())
        pool.spawn(self.execute_adoption_rate())
        pool.spawn(self.execute_probe_template())
        pool.spawn(self.execute_event_explorer4())
        pool.spawn(self.execute_event_explorer_task())
        pool.spawn(self.execute_event_org())
        pool.spawn(self.execute_event_template())
        pool.spawn(self.execute_job_explorer3())
        pool.spawn(self.execute_job_explorer4())
        pool.spawn(self.execute_host_explorer2())
        pool.spawn(self.execute_host_explorer())
        pool.spawn(self.execute_probe_template2())
        pool.spawn(self.execute_job_explorer6())
        pool.spawn(self.execute_roi_template())
        pool.join()
